...
// Tue Jun  9 00:04:01 2015 by ROOT version 5.28/00
// from TTree t2/a Tree with data
// found on file: tree_circle.root
//////////////////////////////////////////////////////////

#ifndef CerenkovLoop_h
#define CerenkovLoop_h
...
public :
   ...
   CerenkovLoop(TTree *tree=0);
   virtual ~CerenkovLoop();
...
#ifdef CerenkovLoop_cxx
CerenkovLoop::CerenkovLoop(TTree *tree)
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      if (!f) {
         f = new TFile("_root/tree_circle.root");
      }
...
CerenkovLoop::~CerenkovLoop()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t CerenkovLoop::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CerenkovLoop::LoadTree(Long64_t entry)
{
...
void CerenkovLoop::Init(TTree *tree)
{
...
void CerenkovLoop::Show(Long64_t entry)
{
...
Int_t CerenkovLoop::Cut(Long64_t entry)
{
