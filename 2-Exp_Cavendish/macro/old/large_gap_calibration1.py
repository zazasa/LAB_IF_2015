...
# @Last Modified time: 2015-12-03 18:55:51
...
data = np.loadtxt('../data/151203_calibration_largegap2.txt')
time = array("f",data[:,0])
voltages = array("f",data[:,1])



# cutx = (time.index(366.),time.index(480.))
...
max_intervals = [
    (0,time.index(380.)),
    (time.index(410.),time.index(420.)),
    # (time.index(440.),time.index(460.)),
]


min_intervals = [
    (time.index(390.),time.index(410.)),
    (time.index(420.),time.index(440.)),
